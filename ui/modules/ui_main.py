...
"background-repeat: no-repeat;")
        ...
        self.gridLayout_5.addWidget(self.btn_startFileOperation, 0, 4, 2, 1)
        ...
        self.gridLayout_5.addWidget(self.fileOperationType, 0, 3, 2, 1)

        self.filePath = QLineEdit(self.verticalLayoutWidget_2)
        self.filePath.setObjectName(u"filePath")
        self.filePath.setMinimumSize(QSize(0, 30))
        self.filePath.setStyleSheet(u"background-color: rgb(33, 37, 43);")

        self.gridLayout_5.addWidget(self.filePath, 0, 1, 1, 1)

        self.btn_fileSelection = QPushButton(self.verticalLayoutWidget_2)
        self.btn_fileSelection.setObjectName(u"btn_fileSelection")
        self.btn_fileSelection.setMinimumSize(QSize(100, 30))
        self.btn_fileSelection.setFont(font)
        self.btn_fileSelection.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btn_fileSelection.setStyleSheet(u"background-color: rgb(52, 59, 72);")

        self.gridLayout_5.addWidget(self.btn_fileSelection, 0, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.path, 1, 0, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.requestMethod.setCurrentText("")
        ...
        self.filePath.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u8bf7\u8f93\u5165\u8981\u8bfb\u53d6\u6216\u5199\u5165\u7684\u8def\u5f84", None))
        self.btn_fileSelection.setText(QCoreApplication.translate("MainWindow", u"\u6587\u4ef6\u9009\u62e9", None))
        self.path.setText("")
