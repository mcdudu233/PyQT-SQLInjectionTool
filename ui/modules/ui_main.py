...
"")
        ...
        self.titleLeftApp.setGeometry(QRect(70, 16, 160, 20))
        font1 = QFont()
        ...
        self.gridLayout_2.addWidget(self.btn_startInjection, 7, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.groupBox_2, 5, 0, 3, 4)
        ...
        self.gridLayout_2.addWidget(self.btn_addParam, 5, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.https, 0, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.databaseType, 3, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.autoUrl, 0, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.injectionType, 2, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_deleteParam, 6, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.paramInput, 4, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.inspectionInterval, 4, 2, 1, 2)

        self.stackedWidget.addWidget(self.manualInjection)
        self.dataCenter = QWidget()
        self.dataCenter.setObjectName(u"dataCenter")
        self.widget = QWidget(self.dataCenter)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(0, 0, 811, 441))
        self.widget_7 = QWidget(self.widget)
        self.widget_7.setObjectName(u"widget_7")
        self.widget_7.setGeometry(QRect(20, 330, 781, 101))
        ...
        self.gridLayout_3.addWidget(self.btn_getData, 1, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_exportData, 1, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_getDatabaseContent, 1, 1, 1, 1)

        self.groupBox_4 = QGroupBox(self.widget)
        self.groupBox_4.setObjectName(u"groupBox_4")
        self.groupBox_4.setGeometry(QRect(20, 50, 221, 251))
        self.gridLayout_9 = QGridLayout(self.groupBox_4)
        self.gridLayout_9.setObjectName(u"gridLayout_9")
        self.databaseInformation = QTableWidget(self.groupBox_4)
        ...
        self.gridLayout_9.addWidget(self.databaseInformation, 0, 0, 1, 1)

        self.groupBox_3 = QGroupBox(self.widget)
        self.groupBox_3.setObjectName(u"groupBox_3")
        self.groupBox_3.setGeometry(QRect(250, 50, 221, 251))
        self.gridLayout_7 = QGridLayout(self.groupBox_3)
        self.gridLayout_7.setObjectName(u"gridLayout_7")
        self.databaseTree = QTreeView(self.groupBox_3)
        self.databaseTree.setObjectName(u"databaseTree")

        self.gridLayout_7.addWidget(self.databaseTree, 0, 0, 1, 1)

        self.groupBox_31 = QGroupBox(self.widget)
        self.groupBox_31.setObjectName(u"groupBox_31")
        self.groupBox_31.setGeometry(QRect(480, 50, 311, 251))
        self.gridLayout_4 = QGridLayout(self.groupBox_31)
        self.gridLayout_4.setObjectName(u"gridLayout_4")
        self.tableInformation = QTableWidget(self.groupBox_31)
        ...
        self.gridLayout_4.addWidget(self.tableInformation, 0, 0, 1, 1)
        ...
        self.browse = QPushButton(self.gridWidget)
        ...
        self.btn_startCommand = QPushButton(self.frame_8)
        ...
        self.gridLayout_8.addWidget(self.btn_startCommand, 0, 2, 1, 1)

        self.commandInput = QLineEdit(self.frame_8)
        ...
        self.echoResults = QCheckBox(self.frame_8)
        ...
        self.widget_2 = QWidget(self.logCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_4.setTitle(QCoreApplication.translate("MainWindow", u"\u6570\u636e\u5e93\u4fe1\u606f", None))
        ...
        self.groupBox_3.setTitle(QCoreApplication.translate("MainWindow", u"\u6570\u636e\u5e93\u7ed3\u6784", None))
        self.groupBox_31.setTitle(QCoreApplication.translate("MainWindow", u"\u8868\u4fe1\u606f", None))
